...
class WeatherController < ApplicationController
  ...
  def location_data
    ...
    respond_to do |format|
      format.json { render json: Weather.get_location_weather_json(@weathers) }
      format.html {}
    end
  end
  ...
  def postcode_data
    ...
    respond_to do |format|
      format.json { render json: Weather.get_postcode_weather_json(@locations, @location_weathers) }
      format.html {}
    end
  end
